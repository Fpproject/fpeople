	...
	<body>
            ...
            <nav class="navbar navbar-toggleable-md navbar-inverse no-padding">
                ...
                <div class="collapse navbar-collapse" id="menu">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Snatch</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id='header-slide' class="container-fluid">
            <section id='slider-home' class="center slider">
                    <div>
                        <img src="assets/images/web_potrait_slide.jpg" />
                    ...
                    <div class="web_potrait">
                        ...
                        <div class="col col-md-3 col-xs-12 sidebar-offcanvas" id="sidebar">
                            <div class="side-section">
                                ...
                                <ul class="side-list">
                                    <li><a href="#" class="active">Beauty Trend</a></li>
                                    <li><a href="#" class="">Beauty News</a></li>
                                    <li><a href="#" class="">Suitor</a></li>
                                    <li><a href="#" class="">Beauty Box</a></li>
                                </ul>
                            </div>
                            <div class="side-section">
                        ...
                        <div class="col col-md-9 col-xs-12 fashion-1">
                            <div class="row">
                                <div class="col col-md-8 col-sm-12">
                                    <img class="card-img-top" src="assets/images/fashion1.jpg" alt="Card image cap">
                                    <div class="detail-text-sashion">
                                        <h3>Prada – Spring 2018</h3>
                                        <p>
                                            Inspirasi Miuccia Prada untuk koleksi Spring 2018 ini adalah komik yang keduanya terinspirasi dan diilustrasikan pada koleksinya – sejumlah topcoats pada herringbone, mata burung, atau unta dan wool abu-abu. Pada koleksi Anda dapat menikmati koleksi yang dilengkapi oleh signature style Prada, yang menggabungkan design ilustrasi yang fun. Para tamu diperkenalkan pada komisi grafis Prada saat mereka memasuki area event. Panel dari kolaborator James Jean dan grafis artis dari Belgia Ollie Schrauwen dilukiskan di seluruh lantai, dinding dan atap ruangan.
                                        </p>
                                    </div>
                                </div>
                                <div class="col col-md-4 side-img">
                                    <img class="card-img-top" src="assets/images/fashion2.jpg" alt="Card image cap">
                                    <img class="card-img-top" src="assets/images/fashion3.jpg" alt="Card image cap">       
                                </div>
                            </div>
                        </div>
